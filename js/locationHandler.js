...
fetch('http://localhost:8888/api/buildings').then(function (response) {
  ...
  var ok = Object.entries(data.data).map(function (_ref) {
    ...
    return thing.latitude > userCoords.latitude - .5 && thing.latitude < userCoords.latitude + .5 && thing.longitude > userCoords.longitude - .5 && thing.longitude < userCoords.longitude + .5;
  });
