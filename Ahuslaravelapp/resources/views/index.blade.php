            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                        <img class="img-responsive pull-left flip logo hidden-xs animated fadeIn" src="{{ voyager_asset('images/logo-icon.svg') }}" alt="Logo Icon">
                        @else
                        ...
                        <div class="copy animated fadeIn">
                            ...
                            <p>Welcome to Akademiska Hus admin page</p>
                        </div>
